...
<!doctype html>
    <head>
        ...
        <meta property="og:description" content="Shoot gif with your friends or alone !">
    ...
    <header>
      ...
      <ul>
        ...
        <li><a href="together-mode.php">Together Mode</a></li>
    ...
    <ul>
      <li><a href="together-mode.php">with your friends ?</a></li>
