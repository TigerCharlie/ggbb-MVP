...
<!doctype html>
    <head>
        ...
        <title><?php echo 'My gifs - '.GGBB_ON_TITLE; ?></title>
        ...
        <meta name="apple-mobile-web-app-title" content="<?php echo GGBB_SITE_NAME; ?>">
        ...
        <meta property="og:url"         content="<?php echo $url_origin.'/gifs_list.php'; ?>">
        <meta property="og:title"       content="<?php echo 'My gifs - '.GGBB_ON_TITLE; ?>">
        <meta property="og:description" content="<?php echo 'All the gifs i shoot with my friends !'; ?>">
    ...
    if($reponse->rowCount() > 0){
      while ($donnees = $reponse->fetch())
      {
        ...
        if($donnees['type']=='alone'){
            $again_button='<a href="alone_mode_again.php?uuid='.$donnees['uuid'].'" title="continue this shoot" class="btn alone-again"></a>';
        }else{
            $again_button="";
        }

        echo '<li id="'.$donnees['uuid'].'"><a href="gif.php?uuid='.$donnees['uuid'].'"><figure><img src="'.$thumbnail_url.'" alt="'.$donnees['title'].'" ><figcaption>'.$donnees['title'].'</figcaption><button data-uuid="'.$donnees['uuid'].'" class="btn delete-gif" title="delete this gif"></button>'.$again_button.'</figure></a></li>';
      }
    }else{
