...
window.onload = function()
  ...
  function showFinalGif(gifUrl){
    ...
    var htmlContent ='<img class="mygif" id="finalGif" src="'+gifUrl+'?'+Math.floor(Date.now() / 1000)+'">';
...
function readyToShoot(){
  isReadyToShoot = true;
  showAlertMessage(true, 'You can shooting again !');
...
function continueShoot(){
        ...
        gifTitle = shotBox.dataset.title;
        shootTitle = shotBox.dataset.title;
        log(shotBox.dataset.title);
